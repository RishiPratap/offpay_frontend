...
import 'package:offpay_version_one/dashboard_screen.dart' as DashboardScreen;
import 'package:offpay_version_one/signup.dart';
...
class MyCustomFormState extends State<MyLogin> {
  ...
  void SendCom() async{
    var url = Uri.parse('https://b942-14-139-187-66.ngrok.io/users/login');
